...
/***
 * Memory image source is the exact opposite of PixelGrabber
 * this uses list of pixels to create image
 * whiles the later gets list or array of pixels from an image
 */
import java.awt.*;
...
public class MemoryImageGenerator extends Frame{
	...
	public static void main(String[] args) {
		...
		appwin.setTitle("Memory Image Generator");
